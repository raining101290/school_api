...
router.get('/studentexamid/:examid/:studentid/:randomid', async (req, res, next) => {
  console.log(req.params.randomid)
...
router.get(
  "/examslistteacherfilter/:id/:teacherid/:classname/:version/:page/:limit", auth, async (req, res, next) => {
...
router.post('/bkashpaymentonline', async (req, res, next) => {
  const user = {
    ...
    examname: 'H.S.C Admission Test 2022',
    status: 'approve',
